...
const TableManager = () => {
  ...
  const [selectedFardiPrice, setSelectedFardiPrice] = useState(3000);
  const [selectedZaujiPrice, setSelectedZaujiPrice] = useState(3000);
        ...
        <div className="flex flex-col sm:flex-row justify-center w-full gap-4 mb-6 ">
          <div className="flex items-center justify-center sm:justify-start">
            <select
              ...
              onChange={(e) => setSelectedFardiPrice(parseInt(e.target.value))}
